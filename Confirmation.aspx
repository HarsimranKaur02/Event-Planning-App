<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/Dashboard.master" AutoEventWireup="true" CodeFile="Confirmation.aspx.cs" Inherits="Login_Confirmation" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder3" Runat="Server">
    ...
    <br />
        <br />
    <asp:TextBox ID="TextBox2" runat="server" placeholder="Contact number*" CssClass="box"></asp:TextBox>
    <br />
    <br />
    <table>
      <tr>
    ...
    <br />
        <br />
     <asp:Button ID="ConfirmButton" runat="server" Text="Confirm Booking" cssclass="button" Height="50px" Width="370px" OnClick="ConfirmButton_Click"/>
        <asp:SqlDataSource ID="SqlDataSource2" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [Design]"></asp:SqlDataSource>
     </div>  
</asp:Content>
